...
class AvalCAct : AppCompatActivity() {
    ...
    private lateinit var userAval: Servico
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.act_aval_c)

        userAval = intent.extras?.getParcelable("userAval")!!

        ratingAtendimento = findViewById(R.id.ratingBar_aval_c_atendimento)
        ratingServico = findViewById(R.id.ratingBar_aval_c_servico)
        ratingOrcamento = findViewById(R.id.ratingBar_aval_c_orcamento)
        btn_avaliar = findViewById(R.id.btn_aval_c_salvar)
        barraP = findViewById(R.id.progress_aval)
        ...
        FirebaseFirestore.getInstance().collection("/usersP")
            .document(userAval.userUuid!!)
            .get()
            .addOnSuccessListener { documentSnapshot ->
                user = documentSnapshot.toObject(Users::class.java)!!
                supportActionBar!!.title = "Avaliar ${user.username}"
            }
