...
class AttCAct : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.act_att_c)

        txt_nome = findViewById(R.id.txt_att_c_name)
        txt_cep = findViewById(R.id.txt_att_c_cep)
        btn_atualizar = findViewById(R.id.btn_att_c_edit)
        img_foto = findViewById(R.id.img_att_c_foto)
        barraP = findViewById(R.id.progress_att_c)
    ...
    inner class MyAsyncTask : AsyncTask<String, String, String>() {
        ...
        override fun doInBackground(vararg params: String?): String {
            try {
                ...
                animacao.tradeView(barraP, btn_atualizar)
                Toast.makeText(this@AttCAct, ex.message.toString(), Toast.LENGTH_SHORT)
                    .show()
            }
            return ""
        }
