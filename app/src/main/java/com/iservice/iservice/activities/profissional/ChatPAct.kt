...
class ChatPAct : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.act_chat_p)

        userc = intent.extras?.getParcelable("userc")!!
        supportActionBar!!.title = userc.username

        rv = findViewById(R.id.recycler_chat_p)
        btn_chat = findViewById(R.id.btn_chat_p)
        edit_chat = findViewById(R.id.edit_chat_p)
