...
class ChatCAct : AppCompatActivity() {
            ...
            .addOnSuccessListener {
                ...
                FirebaseFirestore.getInstance().collection("/usersP")
                    ...
                    .addOnSuccessListener { documentSnapshot ->
                        userc = documentSnapshot.toObject(Users::class.java)!!
                        fetchMessages()
    ...
    private fun fetchMessages() {
        ...
        val toId: String = servico.userUuid!!
        ...
        if (message.text?.isEmpty() == false) {
            FirebaseFirestore.getInstance().collection("/conversations")
                ...
                .addOnSuccessListener {
                    ...
                    contact.photoUrl = userc.profileUrl
    ...
    override fun onOptionsItemSelected(item: MenuItem): Boolean {
        when (item.itemId) {
            R.id.avaliar_c -> {
                val intent = Intent(this@ChatCAct, AvalCAct::class.java)
                intent.putExtra("userAval", servico)
