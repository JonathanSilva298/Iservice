...
class CadCAct : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.act_cad_c)

        txt_nome = findViewById(R.id.txt_cadcontratante_nome)
        txt_email = findViewById(R.id.txt_cadcontratante_email)
        txt_senha = findViewById(R.id.txt_cadcontratante_senha)
        txt_cep = findViewById(R.id.txt_cadcontratante_cep)
        txt_cpf = findViewById(R.id.txt_cadcontratante_cpf)
        txt_dataNasc = findViewById(R.id.txt_cadcontratante_nascimento)
        btn_cadastrar = findViewById(R.id.btn_cadcontratante_enter)
        btn_foto = findViewById(R.id.btn_cadcontratante_foto)
        img_foto = findViewById(R.id.img_cadcontratante_foto)
        barraP = findViewById(R.id.progress_c)
    ...
    inner class MyAsyncTask : AsyncTask<String, String, String>() {
        ...
        override fun doInBackground(vararg params: String?): String {
            try {
                ...
                Toast.makeText(this@CadCAct, ex.message.toString(), Toast.LENGTH_SHORT)
                    .show()
            }
            return ""
        }
    ...
    override fun onActivityResult(requestCode: Int, resultCode: Int, data: Intent?) {
        ...
        if (requestCode == 0) {
            ...
            try {
                ...
                img_foto.setImageDrawable(BitmapDrawable(bitmap))
                btn_foto.alpha = 0F
            } catch (e: Exception) {
            }
        }
        ...
        ref.putFile(selectedUri)
            .addOnSuccessListener {
                ref.downloadUrl.addOnSuccessListener {
                    ...
                    val type = "Contratante"
                    val user_contratante = Users(
                        uid, nome, profileUrl, cpf, nascimento, type, user_cep, user_logradouro,
                        user_bairro, user_cidade, user_estado
                    )

                    FirebaseFirestore.getInstance().collection("usersP")
                        .document(uid)
                        .set(user_contratante)
                        .addOnSuccessListener {
                            animacao.tradeView(barraP, btn_cadastrar)
